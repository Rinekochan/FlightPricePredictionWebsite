...
function AboutGroup() {
    return (
        /* Main container for the About Group section */
        <Box sx={{ my: 5, flexGrow: 1 }}>
            <Grid container spacing={3} alignItems="center" justifyContent="center" >
                {/* Grid item for text content, responsive layout */}
                <Grid item xs={12} md={6} >
                    ...
                    {/* Main content describing the origin story of Kamikaze */}
